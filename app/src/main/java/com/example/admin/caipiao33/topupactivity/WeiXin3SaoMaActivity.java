...
public class WeiXin3SaoMaActivity extends ToolbarActivity implements Toolbar.OnMenuItemClickListener
{
    ...
    private void initView()
    {
        ...
        weixin3saomaerweima.setOnLongClickListener(new View.OnLongClickListener()
        {
            @Override
    ...
    @OnClick({R.id.weixin3saomaerweima, R.id.weixin3saomashangyibu, R.id.weixin3saomawoyizhifu})
    ...
    {
        ImageUtils.GetandSaveCurrentImage(WeiXin3SaoMaActivity.this);
    }
