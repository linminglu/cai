package com.example.admin.caipiao33.notification;
...
public class MyNotificationService extends Service
{
    ...
    public PendingIntent getClickPendingIntent(Context context, UMessage msg)
    {
        ...
        PendingIntent clickPendingIntent = PendingIntent.getBroadcast(context, (int) (System.currentTimeMillis()), clickIntent, PendingIntent.FLAG_CANCEL_CURRENT);
    ...
    public PendingIntent getDismissPendingIntent(Context context, UMessage msg)
    {
        ...
        PendingIntent deletePendingIntent = PendingIntent.getBroadcast(context, (int) (System.currentTimeMillis() + 1), deleteIntent, PendingIntent.FLAG_CANCEL_CURRENT);
