...
public class MainActivity extends Activity
{
            ...
            public void onPageFinished(WebView view, String url)
            {
                ...
                if (!StringUtils.isEmpty2(CookieStr))
                {
                    String CookieStr1 = CookieStr.substring(CookieStr.indexOf("token=") + 6, CookieStr
                            .length());
                    UserConfig.getInstance().save(MainActivity.this, CookieStr1);
                }
                KLog.d(LOG_TAG, url);
    ...
    {
        HttpUtil.post(null, null, String.class, MainActivity.this, new MyResponseListener<String>()
        {
            @Override
            public void onSuccess(String result)
            {
                ...
                try
                {
                    ...
                    if (status == 200)
                    {
                        ...
                        if (isFirst)
                        {
                            ...
                            else
                            {
                                ...
                                map.put("data", UserConfig.getInstance()
                                        .getToken(MainActivity.this));
                                showLoadingDialog(true);
                                HttpUtil.post(map, null, String.class, MainActivity.this, new MyResponseListener<String>()
                                {
                                    @Override
                                    public void onSuccess(String result)
                                    {
                        ...
                        {
                            TreeMap<String, String> map = new TreeMap<>();
                            map.put("data", UserConfig.getInstance().getToken(MainActivity.this));
                            showLoadingDialog(true);
                            HttpUtil.post(map, null, String.class, MainActivity.this, new MyResponseListener<String>()
                            {
                                @Override
