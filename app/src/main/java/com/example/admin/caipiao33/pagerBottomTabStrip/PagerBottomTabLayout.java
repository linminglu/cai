package com.example.admin.caipiao33.pagerBottomTabStrip;
...
public class PagerBottomTabLayout extends FrameLayout implements TabStripLinstener
{
    ...
    public Controller onFinishBuild()
    {
        if ((mPagerBottomTabStrip.mMode & TabLayoutMode.CHANGE_BACKGROUND_COLOR) > 0)
        {
            ...
            mChangeColorsView.setBackgroundColor(mPagerBottomTabStrip.mTabItems.get(mPagerBottomTabStrip.mIndex)
                    .getSelectedColor());
    ...
    public void onSelect()
    {
        ...
        {
            mChangeColorsView.addOvalColor(mPagerBottomTabStrip.mTabItems.get(mPagerBottomTabStrip.mIndex)
                    .getSelectedColor(), touch_x, touch_y);
        }
    }
