 ...
 * Date   : 17/8/16
 */
public class WeiXinPayAdapter extends BaseAdapter
{
    private ArrayList<WeiXinPayBean> beanContents = new ArrayList<>();
    ...
    public WeiXinPayAdapter(ArrayList<WeiXinPayBean> beanContents, LayoutInflater mInflater, ListView mListView, BaseActivity baseActivity)
    {
    ...
    public void setBeanContents(ArrayList<WeiXinPayBean> beanContents)
    {
        this.beanContents = beanContents;
    }

    public ArrayList<WeiXinPayBean> getBeanContents()
    {
        return beanContents;
    }
    ...
    {
        final WeiXinPayBean beanContent = beanContents.get(position);
        if (convertView == null)
        {
